...
// --- RENDER FUNCTION MIT INTEGRIERTER FILTER-LOGIK ---
function renderRecipes() {
    ...
    recipes.forEach((recipe, originalIndex) => {
        ...
        // Falls eine Bedingung nicht zutrifft, wird das Element übersprungen
        ...
        card.innerHTML = `
            ...
            <div class="p-5 flex-1 flex flex-col justify-between">
                ...
                <div class="flex items-center justify-between pt-3 border-t border-slate-50">
                    ...
                    <button onclick="deleteRecipe(${originalIndex})" class="text-slate-300 hover:text-rose-500 p-1 rounded-lg hover:bg-rose-50 transition-colors cursor-pointer">
    ...
    // Sonderfall: Rezepte existieren, treffen aber nicht auf die Suche zu
...
function setupEventListeners() {
    ...
    filterButtons.forEach(btn => {
        btn.addEventListener('click', (e) => {
            ...
            // Visuelles Feedback: Selektionsstatus der Buttons umschalten
